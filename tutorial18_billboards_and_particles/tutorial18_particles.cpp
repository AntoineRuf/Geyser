...
int main( void )
{
	...
	do
	{
		...
		for(int i=0; i<newparticles; i++){
			...
			// TODO : coder générateur de distance aléatoire plus joli
			...
			Contenant_Particule[particleIndex].r = (rand() %256);
			Contenant_Particule[particleIndex].g = (rand() % 256);
			Contenant_Particule[particleIndex].b = (rand() % 256);
